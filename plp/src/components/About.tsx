...
export const About: React.FC = () => {
  ...
  const interests = [
    ...
    },
    {
      icon: Trophy,
      title: 'Sports',
      description: 'Likes to play Sepak Takraw, Volleyball, and Badminton.',
    },
  ];
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div className={`${theme === 'dark' ? 'glass-dark' : 'glass'} p-8 rounded-3xl space-y-4`}>
            ...
            <p className="text-gray-300">
              I'm a Computer Science student from Bohol Island State University with a deep passion for technology and innovation. My journey in tech started from a simple curiosity about how things work, which evolved into a professional career in software development.
            </p>
            <p className="text-gray-300">
